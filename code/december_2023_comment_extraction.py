...
import json
from extract_reddit_comments import (
    extract_HockeyMod_comments,
    extract_flair_comments,
...
def main():
    ...
    all_no_flair_comments = extract_user_comments(
        login, start_date, end_date, no_flair_teams_and_users
    )
    all_flaired_comments = extract_flair_comments(
        reddit=login, start_date=start_date, end_date=end_date
    )
