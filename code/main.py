...
#     start_date = datetime(2024, 8, 20).date()
#     end_date = datetime(2024, 8, 27).date()
...
# with open(f'{current_directory}/data/offseason_data/offer_sheet_after_signing_data_24.json', 'w', encoding='utf-8') as fp:
#     json.dump(offersheet_comments, fp, ensure_ascii= False, indent = 4, default = str)
    
# cleaned_offersheet_comments = process_comments(f'{current_directory}/data/offseason_data/offer_sheet_after_signing_data_24.json')
# with open(f'{current_directory}/data/offseason_data/clean_offer_sheet_after_signing_data_24.json', 'w', encoding='utf-8') as fp:
#     json.dump(cleaned_offersheet_comments, fp, ensure_ascii= False, indent = 4, default = str)
        
   
    with open(f'{current_directory}/data/offseason_data/labelled_after_offersheet_data_24.json', 'r') as fp:
